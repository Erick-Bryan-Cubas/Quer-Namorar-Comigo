...
"")
        ...
        self.label.setGeometry(QRect(10, 10, 800, 201))
        self.label.setAlignment(Qt.AlignCenter)
        self.frame_yes = QFrame(self.centralwidget)
        self.frame_yes.setObjectName(u"frame_yes")
        # O primeiro valor é a posição horizontal, o segundo é a posição vertical, o terceiro é a largura e o quarto é a altura
        # Quanto maior o terceiro valor, mais para a direita o objeto vai
        self.frame_yes.setGeometry(QRect(50, 100, 300, 201))
        ...
        self.frame_no.setGeometry(QRect(400, 100, 320, 201))
        ...
        self.coracao.setGeometry(QRect(90, 120, 600, 502))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_yes.setText(QCoreApplication.translate("MainWindow", u"Claro que sim, meu Rei :)", None))
        self.button_no.setText(QCoreApplication.translate("MainWindow", u"Não sou digna, meu Rei", None))
